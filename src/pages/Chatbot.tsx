...
export const Chatbot = () => {
  ...
  const generateSupportResponse = (text: string) => {
    ...
    if (t.includes('sad') || t.includes('cry') || t.includes('depressed')) {
      return "I am so sorry you're feeling this way. It's okay to let those feelings out. Would you like to try a gentle breathing exercise with me, or perhaps just talk more about what's on your mind?";
    }
    ...
    if (t.includes('die') || t.includes('suicide') || t.includes('hurt')) {
      return "I am very concerned about what you're saying. You don't have to carry this alone. Please reach out to a professional or a helpline. In India, you can call AASRA at 91-22-27546669 or Kiran at 1800-599-0019. They are available to help you right now.";
    }
