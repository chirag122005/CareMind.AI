...
export const Chatbot = () => {
  ...
  const generateSupportResponse = (text: string) => {
    ...
    if (
      t.includes("unmotivated") ||
      t.includes("lazy") ||
      t.includes("procrastinating")
    ) {
    ...
    if (
      t.includes("embarrassed") ||
      t.includes("awkward") ||
      t.includes("humiliated")
    ) {
    ...
    if (
      t.includes("friend") ||
      t.includes("friendship") ||
      t.includes("best friend")
    ) {
    ...
    if (
      t.includes("cry myself to sleep") ||
      t.includes("cant stop crying") ||
      t.includes("cry all night")
    ) {
        ...
        <div className="p-4 border-t border-slate-800">
          ...
          <div className="mt-2 flex items-center justify-center gap-2">
            ...
            <p className="text-[10px] text-slate-500 font-medium">
              Powered by MindCare NLP & Safety Triggers
            </p>
          </div>
        </div>
      </div>
